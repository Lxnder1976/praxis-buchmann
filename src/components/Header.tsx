      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full" role="navigation" aria-label="Hauptnavigation">
        <div className="grid grid-cols-3 items-center h-full">
          ...
          <div className="hidden xl:flex justify-end items-center space-x-6 whitespace-nowrap pr-0 -mr-8">
            ...
            <a href="#ueber-mich" className="text-sm text-burgundy hover:text-coral transition-colors whitespace-nowrap">ÜBER MICH</a>
            <a href="#preise" className="text-sm text-burgundy hover:text-coral transition-colors whitespace-nowrap">PREISE</a>
            <a href="#kontakt" className="text-sm text-burgundy hover:text-coral transition-colors whitespace-nowrap">KONTAKT</a>
